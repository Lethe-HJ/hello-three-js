...
class ConvexGeometry extends THREE.BufferGeometry {
  constructor(
    ...
    // const { smoothness, coefficient, maxOffset } = options;
    ...
    //       coefficient * v2.point.distanceTo(face.midpoint),
    //       maxOffset
    //     );
...
class SmoothConvexGeometry {
  ...
  smoothing(geometry) {
    const { smoothness, coefficient, maxOffset } = this.options;
